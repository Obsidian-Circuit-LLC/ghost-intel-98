...
export function ensureContactInput(v: unknown): ContactInput {
  ...
  return {
    ...
    ...(str(o.dob, 'dob') === undefined ? {} : { dob: str(o.dob, 'dob')! }),
    ...(str(o.placeOfBirth, 'placeOfBirth') === undefined ? {} : { placeOfBirth: str(o.placeOfBirth, 'placeOfBirth')! }),
    ...(str(o.address, 'address') === undefined ? {} : { address: str(o.address, 'address')! }),
    ...(str(o.criminalRecord, 'criminalRecord') === undefined ? {} : { criminalRecord: str(o.criminalRecord, 'criminalRecord')! }),
