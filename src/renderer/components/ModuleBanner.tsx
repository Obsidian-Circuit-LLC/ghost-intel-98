...
export type BannerVariant = 'q' | 'briefcase' | 'mail' | 'settings' | 'shred' | 'journal' | 'xls' | 'addressbook';
...
const RAIN: Record<BannerVariant, { glyph: [number, number, number]; fade: [number, number, number, number] }> = {
  ...
  // Matches the banner's own electric blue on its near-black grid.
  addressbook: { glyph: [90, 150, 255], fade: [2, 11, 43, 0.40] },
