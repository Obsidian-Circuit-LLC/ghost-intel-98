...
const MODULE_DOCS: { name: string; desc: string }[] = [
  ...
  { name: 'Q (AI Assistant)', desc: 'Pluggable Ollama (local) or OpenAI-compatible (https). Case context is opt-in per message — selected from the dropdown. API key encrypted in secrets.enc, never seen by the renderer. Use STFU to abort a running generation.' },
