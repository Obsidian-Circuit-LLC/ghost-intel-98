  ...
  if (!streamingEnabled) {
    return (
      <div className="ga98-stations-drawer">
        <p style={{ fontSize: 11, color: 'var(--ga98-text-dim)' }}>Internet streaming is off. Local playback never touches the network; turning this on lets the Jukebox reach the internet for radio.</p>
