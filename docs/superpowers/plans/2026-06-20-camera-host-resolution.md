...
- Scripts: `pnpm typecheck`, `pnpm test`, `pnpm build` (core app). Commit identity: standard (onna-bugeisha-dev-team); end messages with the two trailers (Co-Authored-By + Claude-Session).
