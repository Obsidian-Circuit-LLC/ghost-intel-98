...
describe('registerBuiltins', () => {
  ...
  it('registers every built-in ModuleKey exactly once', () => {
    ...
    const EXPECTED = [
      ...
      'dialterm', 'doc-viewer', 'eyespy', 'geoint', 'ghostscrape', 'help', 'host-info', 'journal', 'mail', 'markets', 'media-player',
      'minesweeper', 'net-explorer', 'news-view', 'notepad', 'osint-toolkit', 'pinball', 'reminders', 'search', 'searchlight', 'settings',
