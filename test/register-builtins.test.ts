...
describe('registerBuiltins', () => {
  ...
  it('registers every built-in ModuleKey exactly once', () => {
    ...
    const EXPECTED = [
      ...
      'dialterm', 'doc-viewer', 'eyespy', 'geoint', 'ghostscrape', 'help', 'host-info', 'investigation-graph', 'invoices', 'journal', 'mail', 'markets', 'media-player',
      'minds-eye', 'minesweeper', 'my-documents', 'net-explorer', 'news-view', 'notepad', 'number-muncher', 'osint-toolkit', 'pinball', 'reminders', 'report', 'search', 'searchlight', 'settings',
