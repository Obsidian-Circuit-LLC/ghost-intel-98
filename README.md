...
> **Install:** download [`GhostAccess98-Setup-3.4.2.exe`](https://github.com/Obsidian-Circuit-LLC/ghost-access-98/releases/latest), verify the SHA-256, **More info → Run anyway** (unsigned).
...
Direct link to current release: [`GhostAccess98-Setup-3.4.2.exe`](https://github.com/Obsidian-Circuit-LLC/ghost-access-98/releases/download/v3.4.2/GhostAccess98-Setup-3.4.2.exe).
