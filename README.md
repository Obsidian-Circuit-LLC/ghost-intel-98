...
Direct link to current release: [`GhostAccess98-Setup-2.0.1.exe`](https://github.com/Obsidian-Circuit-LLC/ghost-access-98/releases/download/v2.0.1/GhostAccess98-Setup-2.0.1.exe).
