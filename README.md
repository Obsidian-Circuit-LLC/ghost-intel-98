...
**feat/socmint-telegram-v1** — Telegram collector built to interface (public-channel harvest, per-burner Tor isolation, encrypt-at-rest, embedding relevance ranking, analyst label capture, IPC wiring, Settings → SOCMINT pane); live validation and library lock pending operator smoke test.
