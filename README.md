...
Direct link to the current release: [`GhostIntel98-Setup-3.14.0-beta.21.exe`](https://github.com/Obsidian-Circuit-LLC/ghost-intel-98/releases/download/v3.14.0-beta.21/GhostIntel98-Setup-3.14.0-beta.21.exe)
...
The current build is **v3.14.0-beta.21**. Each release page carries its own notes + SHA-256.
