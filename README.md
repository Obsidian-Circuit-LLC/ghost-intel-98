...
> **Install:** download [`GhostAccess98-Setup-3.3.0.exe`](https://github.com/Dezirae-Stark/ghost-access-98/releases/latest), verify the SHA-256, **More info → Run anyway** (unsigned).
...
Direct link to current release: [`GhostAccess98-Setup-3.3.0.exe`](https://github.com/Dezirae-Stark/ghost-access-98/releases/download/v3.3.0/GhostAccess98-Setup-3.3.0.exe).
