...
Direct link to the current release: [`GhostIntel98-Setup-3.24.0.exe`](https://github.com/Obsidian-Circuit-LLC/ghost-intel-98/releases/download/v3.24.0/GhostIntel98-Setup-3.24.0.exe)
...
```powershell
Get-FileHash .\GhostIntel98-Setup-3.24.0.exe -Algorithm SHA256
